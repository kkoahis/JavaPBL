...
public class IssueBookForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_MemberName.setText("Tên Cửa Hàng");
        ...
        jLabel_Bookname.setText("Tên Chứng Nhận");
        ...
        jLabel_FirstName8.setText("Ngày Thu Hồi");
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(jSpinner_IDBook, javax.swing.GroupLayout.Alignment.TRAILING)))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(5, 5, 5)
                                        .addComponent(jLabel_Available, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(5, 5, 5)
                                        .addComponent(jDateChooser_NgayCap, javax.swing.GroupLayout.PREFERRED_SIZE, 243, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addComponent(jDateChooser_NgayHuy, javax.swing.GroupLayout.PREFERRED_SIZE, 243, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(28, 28, 28)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
//            else if (!issueBook.checkBookAvailability(id_chungnhan)) {
//                JOptionPane.showMessageDialog(null, "Chứng nhận này không có sẵn", "Chứng nhận không có sẵn", 2);
//            } 
                ...
                issueBook.addIssue(id_chungnhan, id_cuahang, ngaycap, ngayhuy);
    ...
    private void jButton_Select_MemberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Select_MemberActionPerformed
        ...
        try {
            ...
            if (selectedCuaHang != null) {
                ...
                jLabel_MemberName.setText(String.valueOf(selectedCuaHang.getCuaHang()));
    ...
    private void jButton_Select_BookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Select_BookActionPerformed
        ...
        try {
            ...
            if (selectedCN != null) {
                //display the book title 
                jLabel_Bookname.setText(String.valueOf(selectedCN.getName()));
                //set the book exist to true
                book_Exist = true;

                //display the avaiblality
//                if (issueBook.checkBookAvailability(id_chungnhan)) {
