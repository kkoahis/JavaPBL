...
public class Menu extends JPanel {
    ...
    public void setData(ModelUser modelUser) {
            if(!"user".equals(modelUser.getRole())) {
                 addTitle("Quản Lí Người Dùng");  
           addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.INBOX, "Người Dùng", "Danh Sách Người Dùng", "Thêm Người Dùng", "Sửa Người Dùng", "Xóa Người Dùng"));
    ...
    private void init() {
        ...
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MAIL_OUTLINE, "Chứng Nhận","Quản Lí Chứng Nhận" ,"Cấp Chứng Nhận"));
        addTitle("Quản Lí Cửa Hàng");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MESSAGE, "Cửa Hàng"));
        addTitle("Thanh Tra Cửa Hàng");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MESSAGE, "Thanh Tra Cửa Hàng"));
    }
